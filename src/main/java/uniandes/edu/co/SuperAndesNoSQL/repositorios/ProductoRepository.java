...
public interface ProductoRepository extends MongoRepository<Producto, String> {
    ...
    void actualizarProducto(Integer codBarras, String nombre, Integer precioUnitarioVenta, String presentacion, Integer cantidadPresentacio, Integer unidadMedia, Date fechaExpiracion, EspecificacionesEmpacado id_expecificacionesEmpacado, Integer id_categoria);
